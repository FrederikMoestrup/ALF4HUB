...
public class ProfanityFilter {
    ...
    /**
     * Tjekker om en BlogPost indeholder bandeord i enten title eller content.
     */
    public static boolean containsProfanity(BlogPost blogPost) {
        return containsProfanity(blogPost.getTitle()) || containsProfanity(blogPost.getContent());
    }
}