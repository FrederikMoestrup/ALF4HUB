  ...
  const [tournaments, setTournaments] = useState([
    {
      ...
      registeredTeams: 3,
      prize: '€1000',
      description: 'The biggest summer tournament for CS2 players. Join now and compete for glory!'
    },
    {
      id: 2,
      ...
      registeredTeams: 12,
      prize: '€2500',
      description: 'Annual winter tournament featuring top LoL teams from across the region.'
    },
    {
      id: 3,
      ...
      registeredTeams: 6,
      prize: '€750',
      description: 'Fast-paced rocket-powered action in this weekend tournament!'
    },
    {
      id: 4,
      ...
      registeredTeams: 8,
      prize: '€1500',
      description: 'The spring showdown for tactical shooter enthusiasts. Concluded with Team Alpha as champions!'
    },
    {
      id: 5,
      ...
      registeredTeams: 10,
      prize: '€2000',
      description: 'Last team standing takes it all in this epic battle royale tournament.'
    }
  ]);
            ...
            filteredTournaments.map(tournament => (
              <div key={tournament.id} className={`tournament-card ${tournament.status}`}>
                ...
                <div className="tournament-card-footer">
                  ...
                  <Link to={`/tournament/${tournament.id}`} className="button-secondary">
                    View Details
                  </Link>
                </div>
              </div>
