...
const apiFacade = {
  ...
  createNotification: async (notification) => {
    const response = await fetchWithAuth('/notifications', 'POST', notification);
    return response;
  },
  ...
  acceptPlayerApplication: async (teamId, playerId) => {
    const response = await fetch(`${API_URL}/teams/${teamId}/applications/${playerId}/accept`, makeOptions("POST", true));
  ...
  rejectPlayerApplication: async (teamId, playerId) => {
    const response = await fetch(`${API_URL}/teams/${teamId}/applications/${playerId}/reject`, makeOptions("POST", true));
